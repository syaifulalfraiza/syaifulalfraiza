...
- RF coverage and quality footprints
- Downlink throughput footprints
...
- Residual analysis
- Interactive Plotly dashboard and geographical analysis

The Linear Regression model achieved an R² of 0.519 and was treated as an analytical baseline rather than a production-grade property valuation model.

Project notebook:  
[Google Colab – Property Value Insight and Decision Analysis](https://colab.research.google.com/drive/1v9h9M_nlvyZHagkPKfAggoockMjrm-Q0?usp=sharing)
...
- Jenkins CI/CD pipeline covering build, testing, linting and deployment
- JMeter performance testing integrated into the Jenkins pipeline
- Docker image build and publication through Jenkins
- Docker image verification across multiple team workstations
- Original-code preservation and documentation for code-quality analysis
- Code refactoring and behaviour-preservation verification
- Comparison of original and refactored code using performance and code-quality measurements

Project technologies:  
Python · Flask · SQLite · Git/GitHub · Jira · Jenkins · Apache JMeter · Docker
...
- Role validation for Student, Teacher, Parent and Administrator users
- Role-based navigation to the appropriate application dashboard
- User-session handling across application modules
- Integration and testing of role-based user access

Project technologies:  
Flutter · Dart · Firebase Authentication · Cloud Firestore · Git · GitHub

Repository:  
[StudyCompanion+](https://github.com/syaifulalfraiza/StudyCompanion)
...
- Tutorials
- Community Forums
- Model, DAO, Service and Controller implementation
- JSP views for the assigned modules
- Database-backed CRUD operations using Hibernate
- Database integration and supporting configuration

Project technologies:  
Java · Spring MVC · Hibernate · JSP · MySQL · Maven · Git · GitHub
